...
var ONEBOOK3D_ADDITIONAL_LANGUAGES = [{
		...
		zoom:'Zoom',
		slope:'Inclinar',
		fromfullscreen:'Reducir',
		tofullscreen:'Ampliar',
		close:'Cerrar',
		left:'Izquierda',
		right:'Derecha',
		toStart:'Al inicio',
		toEnd:'Al final',
		goToHomelink:'Abrir página de inicio',
		clickToOpen:'Clic para abrir',
		useMousewheel:'Usa la rueda del ratón',
		forEasyViewing:'para navegar con comodidad',
		askSaveImage:'Selecciona la página a guardar, por favor',
		or:'o'
	}];
