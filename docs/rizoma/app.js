...
<div style="font-family: Arial, sans-serif; line-height: 1.6; padding: 15px;">
    ...
    <p><span style="color: #d9534f; font-weight: bold;">Busca en esa página el único número de distinto color.</span></p><br>
  ...
  <br> Vuelve al enlace  y busca la tarjeta que corresponda al resultado, el texto resaltado es la clave para ingresar a la siguiente tarjeta "Voces del territorio" .</span></p>
